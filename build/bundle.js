var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	let t4_value = (/*secondsLeft*/ ctx[0] === totalSeconds
    	? "Start"
    	: "Reset") + "";
    	...
    	return {
    		c() {
    			...
    			t4 = text(t4_value);
    			attr(h2, "bp", "offset-5@md offset-5@lg 4@md 12@sm");
    			attr(div0, "bp", "grid");
    			attr(button, "bp", "offset-5@md 4@md 12@sm");
    			attr(button, "class", "svelte-vqojt5");
    			attr(div1, "bp", "grid");
    		},
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(button, "click", function () {
    					if (is_function(/*secondsLeft*/ ctx[0] === totalSeconds
    					? /*handleStartTimer*/ ctx[2]
    					: /*handleResetTimer*/ ctx[3])) (/*secondsLeft*/ ctx[0] === totalSeconds
    					? /*handleStartTimer*/ ctx[2]
    					: /*handleResetTimer*/ ctx[3]).apply(this, arguments);
    				});
    		...
    		p(new_ctx, [dirty]) {
    			...
    			if ((!current || dirty & /*secondsLeft*/ 1) && t4_value !== (t4_value = (/*secondsLeft*/ ctx[0] === totalSeconds
    			? "Start"
    			: "Reset") + "")) set_data(t4, t4_value);
    		},
    		i(local) {
    			if (current) return;
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*secondsLeft*/ 1) {
    			 $$invalidate(1, progress = (totalSeconds - secondsLeft) / totalSeconds * 100);
    		}
    	};

    	return [secondsLeft, progress, handleStartTimer, handleResetTimer];
    }
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			h1 = element("h1");
    			h1.textContent = "Washy: Wash your hands!";
    			t1 = space();
    			...
    			t3 = space();
    			h3 = element("h3");
    			h3.innerHTML = `<a target="_blank" href="https://www.who.int/gpsc/clean_hands_protection/en/">Picture Source</a>`;
    			attr(h1, "bp", "text-center");
    			attr(h3, "bp", "text-center");
    		},
    		m(target, anchor) {
